	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{asset('images/icon.png')}}" style="width: 90%;height:auto;" class="logo-icon" alt="logo icon">
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('Master.location')}}"><i class="bx bx-right-arrow-alt"></i>Workplace/Location </a>
						</li>
						<li> <a href="{{route('master.company')}}"><i class="bx bx-right-arrow-alt"></i>Company Resgistration</a>
						</li>
						<li> <a href="{{route('master.employee')}}"><i class="bx bx-right-arrow-alt"></i>Employee Resgistration</a>
						</li>
						<li> <a href="{{route('master.payoutpayrun')}}"><i class="bx bx-right-arrow-alt"></i>Payrun/Payout Type</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('taxmaster.fedralslab')}}"><i class="bx bx-right-arrow-alt"></i>Federal Tax Slab</a>
						</li>
						<li> <a href="{{route('taxmaster.provitialslab')}}"><i class="bx bx-right-arrow-alt"></i>Provintial Tax Slab</a>
						</li>
						<li> <a href="{{route('taxmaster.fedralrebate')}}"><i class="bx bx-right-arrow-alt"></i> Federal Tax Rebate</a>
						</li>
						<li> <a href="{{route('taxmaster.othertax')}}"><i class="bx bx-right-arrow-alt"></i>Other Taxes </a>
						</li>
						...
						<li>
							<a href="{{route('timesheet')}}">
								...
								<div class="menu-title">Timesheet/Payroll</div>
							</a>
