                    ...
                    {{-- <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form class="row g-2" method="post" action="{{route('master.update_payout')}}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$editpayo->id}}">
                                    <div class="col-md-5">
                                        <label for="inputFirstName" class="form-label">
                                             Add Payout Type</label>
                                        <input type="text" class="form-control" id="inputFirstName"
                                            placeholder="Add Payout Type" name="add_payout" value="{{$editpayo->add_payout}}">
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form class="row g-2" method="post" action="{{route('master.update_payrun')}}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$editpayrun->id}}">
                                    <div class="col-md-4">
                                        <label for="inputFirstName" class="form-label">Add Payrun Type</label>
                                        <input type="text" class="form-control" id="inputFirstName"
                                            placeholder="Add Payrun Type" name="add_payrun" value="{{$editpayrun->add_payrun}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="inputFirstName" class="form-label">Number of Days</label>
                                        <input type="number" class="form-control" id="inputFirstName"
                                            placeholder="Number of Days" name="no_of_days" value="{{$editpayrun->no_of_days}}">
                                    </div>
