                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-2" action="{{ route('master.create_employee') }}" method="post"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="date" class="form-control" id="inputFirstName" placeholder="DOB"
                                        name="DOB">
                                </div>

                                <div class="col-md-2">
                                    <label for="inputFirstName" class="form-label">SIN</label>
                                    <input type="text" class="form-control" id="inputFirstName" placeholder="SIN"
                                        name="sin">
                                </div>
                                <div class="col-md-2">
                                    <label for="inputFirstName" class="form-label">BC DL/ID</label>
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="BC DL/ID" name="bcdl">
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                            checked name="Job_Acceptreject" value="1">
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Job
                                            Accept/Reject</label>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                            checked name="Show_Hide" value="1">
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Show/ Hide Total
                                            Pay</label>
                                    </div>
                                </div>
                                <div class="col-md-4" style="margin-top: 2vh;">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1"
                                            id="Only_Straight_hours" name="Only_Straight_hours">
                                        <label class="form-check-label" for="flexCheckDefault">Only Straight hours
                                            applicable</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="0.001" class="form-control" id="straight"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="0.001" class="form-control" id="overtime1"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="0.001" class="form-control" id="overtime2"
                            ...
                            <tbody>
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        <td> <a target="_blank" href="{{asset($employee->ID_proof)}}">View File</a></td>
                                        <td>
                                            <a target="_blank" href="{{asset($employee->address_proof)}}">View File</a>
                                        ...
                                        <td style="background-color:#fff;">
                                            ...
                                            <button type="button" class="btn1 btn-outline-primary"><i
                                                    ...
                                                    <a href="{{route('master.delete_employee',$employee->id)}}"> <button type="button" class="btn1 btn-outline-danger"><i class='bx bx-trash me-0'></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            $(".add-row").click(function() {
                    if (payout_categories.includes($('#category').val())) {
                        ...
                        var markup =
                            ...
                            '<tr><td><input type="hidden" name="select_categories[]" value="' + $('#category')
                            .val() + '"><input type="text"  style="border:none; width: 100%;" value="' +
                            category +
                            '"></td><td><input type="text" name="straight_pay_hours[]" style="border:none; width: 100%;" value="' +
                            straight +
                            '"></td><td><input type="text" name="overtime_hours1[]" style="border:none; width: 100%;" value="' +
                            overtime1 +
                            '"></td><td><input type="text" name="overtime_hours2[]" style="border:none; width: 100%;" value="' +
                            overtime2 +
                            '"></td><button type="button" class="btn1 btn-outline-danger delete-row"><i class="bx bx-trash me-0"></i></button></td></tr>';
