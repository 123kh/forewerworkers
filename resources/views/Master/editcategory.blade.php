                            ...
                            <form class="row g-2" action="{{route('master.update_location')}}" method="post">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Enter Workplace/Location" name="location" value="{{$editlocation->location}}">
                                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2" action="{{route('master.update_category')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{$editcat->id}}">
                                <div class="col-md-5">
                                    <label for="inputFirstName" class="form-label">Enter Category</label>
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Enter Category" name="add_category" value="{{$editcat->add_category}}">
                                </div>
                            ...
                            <table id="example3" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color:#fff;">    <a href="{{route('master.edit_category',$cats->id)}}"><button type="button" class="btn1 btn-outline-primary"><i
